...
if ( !function_exists('us_demo_import'))
{
	function us_demo_import()
	{
		...
		<form class="w-importer" action="?page=us_demo_import" method="post">
			...
			<h1 class="w-importer-title">Success Demo Import (<a href="http://Success.wwwlogix.com/" target="_blank">preview</a>)</h1>
			...
			<div class="w-importer-list">
				...
				<div class="w-importer-item">
					...
					<div class="w-importer-item-btn">
						<a class="button" href="http://Success.wwwlogix.com/" target="_blank">Preview</a>
					</div>
				</div>
...
//		}
		...
		if(!empty($menus))
		{
			...
			{
				if(is_object($menu) && $menu->name == 'Success Header Menu')
				{
