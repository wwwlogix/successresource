...
$meta_boxes[] = array(
	'id' => 'Success_post_page_portfolio_header_settings',
...
$meta_boxes[] = array(
	'id' => 'wwwlogix_page_portfolio_header_settings',
...
if (in_array( 'bbpress/bbpress.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
	$meta_boxes[] = array(
		'id' => 'wwwlogix_forum_header_settings',
		'title' => 'Title Bar Settings',
...
$meta_boxes[] = array(
	'id' => 'wwwlogix_common_footer_settings',
