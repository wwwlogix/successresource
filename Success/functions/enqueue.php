...
function us_custom_styles()
{
	...
	$styles_file = $styles_dir.'/us_Success_custom_styles.css';

	if (get_template_directory_uri() !=  get_stylesheet_directory_uri()){
		wp_register_style('wwwlogix-style' ,  get_stylesheet_directory_uri() . '/style.css', array(), $theme_version, 'all');
		wp_enqueue_style('wwwlogix-style');
	}

	if (file_exists($styles_file)){
		wp_register_style('us_custom_css', $wp_upload_dir['baseurl'] . '/us_custom_css/us_Success_custom_styles.css', array(), $theme_version, 'all');
