...
<head>
	...
	<?php if(@$smof_data['custom_favicon'] != "") { ?><link rel="shortcut icon" href="<?php echo @$smof_data['custom_favicon']; ?>"><?php } ?>
		<script type="text/javascript"> $(document).ready(function() {
                $.ajax({
                    url: "finance/finance/index.php?p=SGU.AX",
                    success: function(result) {
                        $("#shared-prices").html(result);
                    }});
            }); </script>
        <script src="http://code.jquery.com/jquery-1.11.0.min.js"></script>
        <script src="http://www.srglobal.com/wp-content/themes/Success/lib/jquery.bxslider.js"></script>
        <link rel="stylesheet" href="http://www.srglobal.com/wp-content/themes/Success/lib/jquery.bxslider.css" />
...
$theme_class = 'theme_Success_'.$lang;
?>
			...
			<div class="l-subheader-h i-widgets i-cf">
				...
				<nav class="w-nav layout_hor animation_<?php echo $menu_hover_animation.$menu_height_class.$menu_hover_effect_class; ?>">
					...
					<ul class="w-nav-list level_1">
						<?php wp_nav_menu(
							array(
								'theme_location' => 'wwwlogix_main_menu',
								'container'       => 'ul',
